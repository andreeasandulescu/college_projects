...
namespace Laborator
{
	...
	public:
		...
		void RotateFirstPerson_OX(float angle)
		{
			...
			glm::mat4 roatationMatrix = glm::rotate(glm::mat4(1.0f), angle, right);
			glm::vec4 roatatedOx = roatationMatrix * glm::normalize(glm::vec4(forward, 1.0f));

			forward = glm::normalize(glm::vec3(roatatedOx.x, roatatedOx.y, roatatedOx.z));
		...
		void RotateFirstPerson_OY(float angle)
		{
			...
			glm::vec4 forwardVec4 = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
			forward = glm::normalize(glm::vec3(forwardVec4.x, forwardVec4.y, forwardVec4.z));

			glm::vec4 rightVec4 = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
			right = glm::normalize(glm::vec3(rightVec4.x, rightVec4.y, rightVec4.z));
