...
public class ElementMoreDiff extends TM {			//elementary Turing Machines which can move the head at least once for all symbols but this.symbol

	char moveHead;
	char symbol;

	public ElementMoreDiff(char moveHead, char symbol, String name) {
