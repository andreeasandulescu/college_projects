...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean testTema1 = false;
        
        // TODO Print tree
        var myVisitor = new MyParseTreeVisitor();
        var root = globalTree.accept(myVisitor);
        ...
        {
        	//parcurgere a arborelui AST pentru generarea de erori semantice si verificare de tipuri
        	root.getReturnType(null, null);
        }
